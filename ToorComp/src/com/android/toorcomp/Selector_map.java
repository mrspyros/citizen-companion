	...
	public void onCreate(Bundle savedInstanceState) {
		...
		selectBtn.setOnClickListener(new android.view.View.OnClickListener(){
		    public void onClick(View v) {
		    	...
		    	finish();
		        //Toast.makeText(getApplicationContext(), "Η Επιλογή σας είναι"+(m_mapView.getMapCenter().getLongitudeE6()+" - "+m_mapView.getMapCenter().getLatitudeE6()), Toast.LENGTH_LONG).show(); 
