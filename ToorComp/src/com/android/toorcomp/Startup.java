...
public class Startup {
	...
	public Boolean CheckXML() {
		...
		// return
		// CheckFileExists(Environment.getExternalStorageDirectory().getAbsolutePath()+"/osmdroid/");

		return CheckFileExists(Environment.getExternalStorageDirectory()
				.getAbsolutePath() + "/osmdroid/Options.xml");
